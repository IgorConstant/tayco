...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02-Dez-2022 às 00:13
...
CREATE TABLE `app_acessorio` (
  ...
  `aplicacao` longtext COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `app_banner` (
  ...
  `texto_suporte` longtext COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `app_blog` (
  ...
  `content_post` longtext COLLATE utf8_bin DEFAULT NULL,
...
--
-- Estrutura da tabela `app_cor`
--

CREATE TABLE `app_cor` (
  `id` int(11) NOT NULL,
  `nome_cor` varchar(120) COLLATE utf8_bin DEFAULT NULL,
  `slug` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Extraindo dados da tabela `app_cor`
--

INSERT INTO `app_cor` (`id`, `nome_cor`, `slug`, `created_at`) VALUES
(1, 'Azul', 'azul', '2022-12-01 22:48:31'),
(2, 'Preto', 'preto', '2022-12-01 22:48:42'),
(3, 'Cinza', 'cinza', '2022-12-01 22:48:51'),
(4, 'Branco', 'branco', '2022-12-01 22:48:57');

-- --------------------------------------------------------

--
-- Estrutura da tabela `app_filtragem_mecanica`
--

CREATE TABLE `app_filtragem_mecanica` (
  `id` int(11) NOT NULL,
  `nome_filtragem` varchar(120) COLLATE utf8_bin DEFAULT NULL,
  `slug` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Extraindo dados da tabela `app_filtragem_mecanica`
--

INSERT INTO `app_filtragem_mecanica` (`id`, `nome_filtragem`, `slug`, `created_at`) VALUES
(1, 'PFF1 (S)', 'pff1-s', '2022-12-01 22:52:04'),
(2, 'PFF2 (S)', 'pff2-s', '2022-12-01 22:52:29'),
(3, 'PFF2 (SL)', 'pff2-sl', '2022-12-01 22:53:01'),
(4, 'PFF3 (S)', 'pff3-s', '2022-12-01 22:53:15'),
(5, 'P2 (S)', 'p2-s', '2022-12-01 22:53:28'),
(6, 'P3 (SL)', 'p3-sl', '2022-12-01 22:54:38');

-- --------------------------------------------------------

--
-- Estrutura da tabela `app_filtragem_quimica`
--

CREATE TABLE `app_filtragem_quimica` (
  `id` int(11) NOT NULL,
  `nome_filtragem` varchar(120) COLLATE utf8_bin DEFAULT NULL,
  `slug` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
...
--
-- Extraindo dados da tabela `app_filtragem_quimica`
--

INSERT INTO `app_filtragem_quimica` (`id`, `nome_filtragem`, `slug`, `created_at`) VALUES
(1, 'Vapores Orgânicos', 'vapores-organicos', '2022-12-01 22:49:28'),
(2, 'Gases Ácidos', 'gases-acidos', '2022-12-01 22:49:58'),
(3, 'Vapores Orgânicos e Gases Ácidos', 'vapores-organicos-e-gases-acidos', '2022-12-01 22:50:52'),
(4, 'Amônia e Metilamina', 'amonia-metilamina', '2022-12-01 22:51:09'),
(5, 'Multigases', 'multigases', '2022-12-01 22:51:32');
...
--
-- Extraindo dados da tabela `app_linha`
--

INSERT INTO `app_linha` (`id`, `nome_linha`, `slug`, `status`, `created_at`) VALUES
(1, 'Linha T-9500', 'linha-t9500', NULL, '2022-12-01 22:59:53'),
(2, 'Linha T-9550', 'linha-t9550', NULL, '2022-12-01 23:00:07'),
(3, 'Linha T', 'linha-t', NULL, '2022-12-01 23:00:18'),
(4, 'Linha ST', 'linha-st', NULL, '2022-12-01 23:02:31'),
(5, 'Linha Hospitalar', 'linha-hospitalar', NULL, '2022-12-01 23:03:31');
...
--
-- Estrutura da tabela `app_produto_tem_cor`
--

CREATE TABLE `app_produto_tem_cor` (
  `id` int(11) NOT NULL,
...
--
-- Extraindo dados da tabela `app_produto_tem_cor`
--

INSERT INTO `app_produto_tem_cor` (`id`, `produto_id`, `cor_id`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 3, 1);
...
--
-- Estrutura da tabela `app_produto_tem_filtragem_mecanica`
--

CREATE TABLE `app_produto_tem_filtragem_mecanica` (
  `id` int(11) NOT NULL,
  `produto_id` int(11) DEFAULT NULL,
  `filtragem_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Extraindo dados da tabela `app_produto_tem_filtragem_mecanica`
--

INSERT INTO `app_produto_tem_filtragem_mecanica` (`id`, `produto_id`, `filtragem_id`) VALUES
(1, 1, 1),
(2, 3, 2);
...
--
-- Estrutura da tabela `app_produto_tem_filtragem_quimica`
--

CREATE TABLE `app_produto_tem_filtragem_quimica` (
  `id` int(11) NOT NULL,
  `produto_id` int(11) DEFAULT NULL,
  `filtragem_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
-- Extraindo dados da tabela `app_produto_tem_filtragem_quimica`
--

INSERT INTO `app_produto_tem_filtragem_quimica` (`id`, `produto_id`, `filtragem_id`) VALUES
(1, 1, 1),
(2, 1, 2);
...
--
-- Estrutura da tabela `app_produto_tem_linha`
--

CREATE TABLE `app_produto_tem_linha` (
  `id` int(11) NOT NULL,
  `produto_id` int(11) DEFAULT NULL,
...
--
-- Extraindo dados da tabela `app_produto_tem_linha`
--

INSERT INTO `app_produto_tem_linha` (`id`, `produto_id`, `linha_id`) VALUES
(1, 1, 3),
(2, 3, 3);
...
--
-- Estrutura da tabela `app_produto_tem_tipo_produto`
--

CREATE TABLE `app_produto_tem_tipo_produto` (
  `id` int(11) NOT NULL,
  `produto_id` int(11) DEFAULT NULL,
...
--
-- Extraindo dados da tabela `app_produto_tem_tipo_produto`
--

INSERT INTO `app_produto_tem_tipo_produto` (`id`, `produto_id`, `tipo_id`) VALUES
(1, 1, 1),
(2, 3, 3);
...
--
-- Estrutura da tabela `app_tipo_produto`
--

CREATE TABLE `app_tipo_produto` (
  `id` int(11) NOT NULL,
  `nome_tipo` varchar(120) COLLATE utf8_bin DEFAULT NULL,
  `slug` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Extraindo dados da tabela `app_tipo_produto`
--

INSERT INTO `app_tipo_produto` (`id`, `nome_tipo`, `slug`, `created_at`) VALUES
(1, 'Respirador Semifacial', 'respirador-semifacial', '2022-12-01 23:03:46'),
(2, 'Respirador Facial Inteiro', 'respirador-facial-inteiro', '2022-12-01 23:04:23'),
(3, 'Respirador Descartável', 'respirador-descartavel', '2022-12-01 23:04:53'),
(4, 'Filtros para Partículas', 'filtros-para-particulas', '2022-12-01 23:05:12'),
(5, 'Filtros Químicos', 'filtros-quimicos', '2022-12-01 23:05:30');
...
--
-- Índices para tabela `app_cor`
--
ALTER TABLE `app_cor`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `app_filtragem_mecanica`
--
ALTER TABLE `app_filtragem_mecanica`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `app_filtragem_quimica`
--
ALTER TABLE `app_filtragem_quimica`
  ADD PRIMARY KEY (`id`);
...
--
-- Índices para tabela `app_produto_tem_cor`
--
ALTER TABLE `app_produto_tem_cor`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `app_produto_tem_filtragem_mecanica`
--
ALTER TABLE `app_produto_tem_filtragem_mecanica`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `app_produto_tem_filtragem_quimica`
--
ALTER TABLE `app_produto_tem_filtragem_quimica`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `app_produto_tem_linha`
--
ALTER TABLE `app_produto_tem_linha`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `app_produto_tem_tipo_produto`
--
ALTER TABLE `app_produto_tem_tipo_produto`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `app_tipo_produto`
--
ALTER TABLE `app_tipo_produto`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `app_cor`
--
ALTER TABLE `app_cor`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `app_filtragem_mecanica`
--
ALTER TABLE `app_filtragem_mecanica`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de tabela `app_filtragem_quimica`
--
ALTER TABLE `app_filtragem_quimica`
...
--
-- AUTO_INCREMENT de tabela `app_produto_tem_cor`
--
ALTER TABLE `app_produto_tem_cor`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabela `app_produto_tem_filtragem_mecanica`
--
ALTER TABLE `app_produto_tem_filtragem_mecanica`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `app_produto_tem_filtragem_quimica`
--
ALTER TABLE `app_produto_tem_filtragem_quimica`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `app_produto_tem_linha`
--
ALTER TABLE `app_produto_tem_linha`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `app_produto_tem_tipo_produto`
--
ALTER TABLE `app_produto_tem_tipo_produto`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `app_tipo_produto`
--
ALTER TABLE `app_tipo_produto`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
