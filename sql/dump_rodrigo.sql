...
MySQL - 10.4.22-MariaDB : Database - tayco
*********************************************************************
*/
...
/*Table structure for table `app_acessorio` */

DROP TABLE IF EXISTS `app_acessorio`;
...
/*Data for the table `app_acessorio` */
...
/*Table structure for table `app_cor` */

DROP TABLE IF EXISTS `app_cor`;

CREATE TABLE `app_cor` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome_cor` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `app_cor` */

insert  into `app_cor`(`id`,`nome_cor`,`slug`,`created_at`) values 
(1,'Azul','azul','2022-12-01 09:29:14'),
(2,'Preto','preto','2022-12-01 09:29:19'),
(3,'Cinza','cinza','2022-12-01 09:29:29'),
(4,'Branco','branco','2022-12-01 09:29:35');

/*Table structure for table `app_filtragem_mecanica` */

DROP TABLE IF EXISTS `app_filtragem_mecanica`;

CREATE TABLE `app_filtragem_mecanica` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome_filtragem` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `app_filtragem_mecanica` */

insert  into `app_filtragem_mecanica`(`id`,`nome_filtragem`,`slug`,`created_at`) values 
(1,'PFF1 (S)','pff1-s','2022-12-01 09:14:42'),
(2,'PFF2 (S)','pff2-s','2022-12-01 09:14:56'),
(3,'PFF2 (SL)','pff2-sl','2022-12-01 09:15:07'),
(4,'PFF3 (S)','pff3-s','2022-12-01 09:15:17'),
(5,'P2 (S)','p2-s','2022-12-01 09:15:28'),
(6,'P3 (SL)','p3-sl','2022-12-01 09:15:37');

/*Table structure for table `app_filtragem_quimica` */

DROP TABLE IF EXISTS `app_filtragem_quimica`;
...
/*Data for the table `app_filtragem_quimica` */

insert  into `app_filtragem_quimica`(`id`,`nome_filtragem`,`slug`,`created_at`) values 
(1,'Vapores Orgânicos','vapores-organicos','2022-12-01 09:22:07'),
(2,'Gases Ácidos','gases-acidos','2022-12-01 09:22:18'),
(3,'Vapores Orgânicos e Gases Ácidos','vapores-gases','2022-12-01 09:22:28'),
(4,'Amônia e Metilamina','amonia-metilamina','2022-12-01 09:22:38'),
(5,'Multigases','multigases','2022-12-01 09:22:48');
...
/*Table structure for table `app_linha` */

DROP TABLE IF EXISTS `app_linha`;
...
/*Data for the table `app_linha` */

insert  into `app_linha`(`id`,`nome_linha`,`slug`,`status`,`created_at`) values 
(2,'Linha T-9500','t-9500',NULL,'2022-12-01 08:47:25'),
(3,'Linha T-9550','T-9550',NULL,'2022-12-01 08:47:40'),
(4,'Linha T','linha-t',NULL,'2022-12-01 08:47:57'),
(5,'Linha ST','linha-st',NULL,'2022-12-01 08:48:06'),
(6,'Linha Hospitalar','linha-hospitalar',NULL,'2022-12-01 08:48:18');
...
/*Table structure for table `app_produto_tem_cor` */

DROP TABLE IF EXISTS `app_produto_tem_cor`;
...
/*Data for the table `app_produto_tem_cor` */
...
/*Table structure for table `app_produto_tem_filtragem_mecanica` */

DROP TABLE IF EXISTS `app_produto_tem_filtragem_mecanica`;
...
/*Data for the table `app_produto_tem_filtragem_mecanica` */
...
/*Table structure for table `app_produto_tem_filtragem_quimica` */

DROP TABLE IF EXISTS `app_produto_tem_filtragem_quimica`;
...
/*Data for the table `app_produto_tem_filtragem_quimica` */
...
/*Table structure for table `app_produto_tem_linha` */

DROP TABLE IF EXISTS `app_produto_tem_linha`;
...
/*Data for the table `app_produto_tem_linha` */
...
/*Table structure for table `app_produto_tem_tipo_produto` */

DROP TABLE IF EXISTS `app_produto_tem_tipo_produto`;
...
/*Data for the table `app_produto_tem_tipo_produto` */
...
/*Data for the table `app_social` */

/*Table structure for table `app_tipo_produto` */

DROP TABLE IF EXISTS `app_tipo_produto`;

CREATE TABLE `app_tipo_produto` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome_tipo` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `app_tipo_produto` */

insert  into `app_tipo_produto`(`id`,`nome_tipo`,`slug`,`created_at`) values 
(1,'Respirador Semifacial','respirador-semifacial','2022-12-01 09:01:25'),
(2,'Respirador Facial Inteiro','respirador-facial-inteiro','2022-12-01 09:01:43'),
(3,'Respirador Descartável','respirador-descartavel','2022-12-01 09:01:59'),
(4,'Filtros para Partículas','filtros-particulas','2022-12-01 09:02:15'),
(5,'Filtros Químicos','filtros-quimicos','2022-12-01 09:02:30');
